...
abstract class Kernel implements KernelInterface, TerminableInterface
{
    ...
    public const VERSION = '2.8.52';
    public const VERSION_ID = 20852;
    public const MAJOR_VERSION = 2;
    public const MINOR_VERSION = 8;
    public const RELEASE_VERSION = 52;
    public const EXTRA_VERSION = '';

    public const END_OF_MAINTENANCE = '11/2018';
    public const END_OF_LIFE = '11/2019';
    ...
    {
        return [$this->environment, $this->debug];
    }
