...
class XmlFileLoader extends FileLoader
{
    ...
    private function parseDefinition(\DOMElement $service, $file)
    {
        ...
        foreach (['class', 'shared', 'public', 'factory-class', 'factory-method', 'factory-service', 'synthetic', 'lazy', 'abstract'] as $key) {
...
EOF
        ...
        $valid = @$dom->schemaValidateSource($source, LIBXML_NOENT);
