...
class XmlFileLoaderTest extends TestCase
{
    ...
    public function testLoadServices()
    {
        ...
        $this->assertEquals([new Reference('baz', ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, false), 'configure'], $services['configurator2']->getConfigurator(), '->load() parses the configurator tag');
        ...
        $this->assertEquals([new Reference('baz', ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, false), 'getClass'], $services['new_factory2']->getFactory(), '->load() parses the factory tag');
